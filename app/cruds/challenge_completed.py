...
def create_challenge_completed(db: Session, challenge_completed_create: challenge_completed_schema.Challenges_completed) -> challenge_completed_model.Challenge_completed:
